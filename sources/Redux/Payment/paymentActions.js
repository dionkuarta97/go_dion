         ...
         fetch(urlBase + urlPaymentMethod, {
            ...
            .then((json) => {
               if (json.status) {
                  ...
                  dispatch(setPaymentMethod(defaultFailedState(json.message)));
            })
            .catch((err) => {
            ...
            fetch(urlBase + urlPaymentProcess, {
               ...
               .then((json) => {
                  if (json.status) {
                     ...
                     dispatch(
                        setPaymentProcess(defaultFailedState(json.message))
                     );
               })
               .catch((err) => {
         ...
         fetch(urlBase + urlPayment + `?status=${status}`, {
            ...
            .then((json) => {
               if (json.status) {
                  ...
                  dispatch(setPaymentList(defaultFailedState(json.message)));
            })
            .catch((err) => {
         ...
         fetch(urlBase + urlPayment + `/status?order_id=${orderId}`, {
            ...
            .then((json) => {
               if (json.status) {
                  ...
                  dispatch(setPaymentDetail(defaultFailedState(json.message)));
            })
            .catch((err) => {
