                        ...
                        if (!detail.touched) {
                           if (detail.type === "UAS") {
                              ...
                              if (!profile.program_studi) {
                                 Alert.alert(
                                    "Peringatan",
                                    "Tipe soal ini adalah SNBT. Kamu perlu memilih prodi terlebih dahulu untuk mengerjakan soal.",
                                    [
                                       { text: "TIDAK", onPress: () => {} },
                                       {
                                          text: "PILIH",
            ...
            >
               ...
               >
                  ...
                  <Text style={{ ...Fonts.black17Bold }}>
                     TPS ({detail.total_question} Soal -{" "}
                     {detail.total_time / 60} menit)
                  </Text>
