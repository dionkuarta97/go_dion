...
const EmailCheckScreen = () => {
   ...
   useFocusEffect(
      useCallback(() => {
         //** clean redux setiap render halaman email */
   ...
   useEffect(() => {
      if (checkEmail.data !== null) {
         //** navigate jika cek email sukses */
   ...
   useEffect(() => {
      //** validasi email untuk set ke state */
      ...
      <SafeAreaView style={{ flex: 1 }}>
         ...
         <View style={{ padding: Sizes.fixPadding * 2 }}>
            ...
            {checkEmail.error !== null && (
               <Text
                  style={{ color: Colors.neutralRedColor, textAlign: "center" }}
               >
                  {checkEmail.error}
               </Text>
            )}
