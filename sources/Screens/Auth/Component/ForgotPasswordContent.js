...
const ForgotPasswordContent = () => {
   ...
   useEffect(() => {
      //** clear redux setiap screen dirender */
            ...
            <View>
               <View style={{ marginBottom: Sizes.fixPadding }}>
                  <Text style={{ ...Fonts.black17Regular }}>
                     Untuk mengatur ulang password, silakan masukkan email yang
            ...
            <View>
               <View style={{ flex: 1, alignItems: "center" }}>
                  ...
                  <View style={{ marginVertical: 50, alignItems: "center" }}>
                     <Text
                        style={{ ...Fonts.black17Bold, textAlign: "center" }}
                     >
                        Cek Email Kamu
                     </Text>
                     <Text
                        style={{ ...Fonts.black17Regular, textAlign: "center" }}
                     >
